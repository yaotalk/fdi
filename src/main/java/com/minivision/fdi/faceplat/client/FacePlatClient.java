package com.minivision.fdi.faceplat.client;

import com.fasterxml.jackson.databind.JavaType;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.minivision.fdi.entity.Meeting;
import com.minivision.fdi.faceplat.ex.FacePlatException;
import com.minivision.fdi.faceplat.result.RestResult;
import com.minivision.fdi.faceplat.result.detect.CompareResult;
...
import com.minivision.fdi.faceplat.result.detect.faceset.*;
...
public class FacePlatClient {
  @Autowired
  private OAuth2RestTemplate restClient;
  ...
  private <T> RestResult<T> postForResult(String path, LinkedMultiValueMap<String,Object> params, Class<T> resultType) throws
      FacePlatException {
    try {
  ...
  //1:N feature
  public SearchResult searchByFeature(String faceSetToken,String feature,int TopN) throws FacePlatException{
      return searchByFeatureBase(faceSetToken,feature,TopN).getData();
  }
  ...
  @Deprecated
  public RestResult<SearchResult> searchByFeatureBase(String faceSetToken, String feature, int TopN) throws FacePlatException{
    LinkedMultiValueMap<String,Object> params = bulidParams();
    params.add("facesetToken", faceSetToken);
    params.add("faceFeature", feature);
    params.add("resultCount", TopN);
    return postForResult(basePath+"/api/v1/search", params, SearchResult.class);
  }
  ...
  //----- faceset API ----
  public SetCreateResult createFaceset(Meeting meeting) throws FacePlatException{
    return createFacesetBase(meeting).getData();
  }

  public SetModifyResult updateFaceset(Meeting meeting) throws FacePlatException{
    return updateFacesetBase(meeting).getData();
  }

  @Deprecated
  public RestResult<SetModifyResult> updateFacesetBase(Meeting meeting) throws FacePlatException{
    LinkedMultiValueMap<String,Object> params = bulidParams();
    params.add("facesetToken", meeting.getToken());
    params.add("displayName", meeting.getName());
//    params.add("capacity",faceSet.getCapacity());
    return postForResult(basePath+"/api/v1/faceset/modify", params, SetModifyResult.class);
  }

  @Deprecated
  public RestResult<SetCreateResult> createFacesetBase(Meeting meeting) throws FacePlatException{
    LinkedMultiValueMap<String,Object> params = bulidParams();
    params.add("displayName", meeting.getName());
//    params.add("capacity",faceSet.getCapacity());
